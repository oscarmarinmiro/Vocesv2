...
# Django settings for Voces project.
...
MEDIA_ROOT = os.path.join(CURRENT_PATH,"../",'vocesBack','media')
...
import os
TEMPLATE_DIRS = (os.path.join(os.path.dirname(__file__), '..', 'vocesBack','templates').replace('\\','/'),)
