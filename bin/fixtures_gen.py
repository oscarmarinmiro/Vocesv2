...
base_fixtures = json.loads(base_file.read())
...
for fixture in base_fixtures:
    if 'vocesBack' in fixture['model']:
        #print fixture
        #if fixture['model']=='vocesBack.user':
        #    users.append(fixture)
        #    todo.append(fixture)
        if fixture['model']=='vocesBack.config':
            todo.append(fixture)
    else:
        todo.append(fixture)
